...
import br.com.controlefinanceiro.firebase.repository.LeituraRepository;
    ...
    public void getAllSpinnerForUser() {
        try {
            ...
            service.getAllReference()
                    .whereEqualTo("cliente.rota.colaborador.email", FirebaseControleFinanceiro.getEMailUsuario())
