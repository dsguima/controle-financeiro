...
import br.com.controlefinanceiro.firebase.repository.ClienteRepository;
...
public class ClienteViewModel extends BaseViewModel {
   ...
   /* public void delete(Cliente obj){
    ...
    public void getAllUsuario() {
        try {
            service.getAll("rota.colaborador.email", FirebaseControleFinanceiro.getEMailUsuario())
                    .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                        @Override
                        public void onSuccess(QuerySnapshot querySnapshot) {
                            Log.d(TAG, "Listou todos!");
